    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-mb-9 col-lg-9 col-xl-9 content" id="content">
            ...
            <div class="main-content my-4 ml-4">
                ...
                <hr>
                <div class="row my-4">
                    <div class="col-xl-4 col-lg-4 col-mb-4 col-sm-6 my-2">
                    ...
                    <div class="col-xl-4 col-lg-4 col-mb-4 col-sm-6 my-2 text-center pt-2">
...
<script src="/assignment/static/js/map.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyADiDXn2gg7kg2aJr6CCcqy7yHaCIufrbI&callback=initMap"></script>
</body>
</html>