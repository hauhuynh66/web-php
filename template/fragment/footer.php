...
<footer class="text-center">
    <div class="row mt-2">
        <div class="col-xl-4 col-lg-6 col-mb-6 col-sm-12">
            ...
            <a href="/assignment/powerpoint/page1&dls" class="footer-link">Most Downloads</a>
            <a href="/assignment/powerpoint/page1&new" class="footer-link">Recently Uploads</a>
        </div>
        <div class="col-xl-4 col-lg-6 col-mb-6 col-sm-12">
            <p class="text-primary">Web</p>
            <a href="/assignment/web/page1&new" class="footer-link">Most Downloads</a>
            <a href="/assignment/web/page1&new" class="footer-link">Recently Uploads</a>
        </div>
        <div class="col-xl-4 col-lg-6 col-mb-6 col-sm-12">
